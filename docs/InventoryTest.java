public class OwnerInventoryTest extends ActivityInstrumentationTestCase2{
	...
	public void testFindInventory(){
		...
		//Save inventorylist item into an arraylist of items
		Arratlist<Items> itemlist = MyAccount.myInventory()
		//Check the inventory item (0) is item1
		assertTrue(itemlist.get(0) == item1);
        }
	//US01.03.01
	...
	public void testViewItemDetail(){
		...
		//Save inventorylist item into an arraylist of items
		Arratlist<Items> itemlist = MyAccount.myInventory()
		//Test if we can get item detail
		assertTrue(itemlist.get(0).getName().equals("Call of Duty"))
	}
	//US06.02.01
	...
	public void testOpenFriendInv(){
		...
		Arraylist<Items> itemlist = ViewInventory.getInventory()
		//Test if we can get item detail
		assertTrue(itemlist.get(0).getName().equals("Call of Duty"))
	}
	//US03.01.03
	...
	public void testBrowseFriendInventoryText(){
		...
		Arraylist<Items> itemlist = ViewInventory.findItemText("Call");
		//Make sure itemlist found item1
		assertFalse(itemlist.notempty);
		assertTrue(itemlist.get(0).getName().equals("Call of Duty"))
	}
	//US03.01.02
	...
	public void testBrowseFriendInventoryCategory(){
		...
		Arraylist<Items> itemlist = ViewInventory.findItemCategory("New");
		//Make sure itemlist found item1
		assertFalse(itemlist.notempty);
		assertTrue(itemlist.get(0).getName().equals("Call of Duty"))
	}
